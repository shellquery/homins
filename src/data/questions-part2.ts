...
export const questionsPart2: Question[] = [
  ...
  },
  {
    id: 177,
    question:
      "What is the purpose of a sediment trap (drip leg) installed on a gas supply line near an appliance?",
    options: [
      "To regulate gas pressure to the appliance",
      "To allow gas to escape safely in an emergency",
      "To catch debris, moisture, and scale before they enter the gas valve of the appliance",
      "To measure gas consumption for billing",
    ],
    correctAnswer: 2,
    explanation:
      "沉积物捕集器（泄漏弯/drip leg）安装在燃气设备附近的燃气管线上，用于捕获管道中的碎屑、水分和氧化物，防止其进入设备的燃气阀导致故障或损坏。通常安装在设备进气口前的垂直管段底部，是加州燃气规范对每台燃气设备的要求。",
    category: "hvac",
  },
  {
    id: 178,
    question:
      "What is the function of a Thermostatic Expansion Valve (TXV) in an air conditioning or refrigeration system?",
    options: [
      "To compress refrigerant to high pressure",
      "To filter moisture and debris from the refrigerant",
      "To exhaust heat from the condenser coil",
      "To meter the flow of refrigerant into the evaporator based on superheat",
    ],
    correctAnswer: 3,
    explanation:
      "热力膨胀阀（TXV）的功能是根据蒸发器出口的过热度，精确计量流入蒸发器的制冷剂量。它通过调节制冷剂流量来确保蒸发器充分利用，同时防止液态制冷剂进入压缩机（液击）。TXV比活塞式节流装置更精确，能更好地适应负荷变化。",
    category: "hvac",
  },
  {
    id: 179,
  ...
  },
  {
    id: 183,
    question:
      "What does the HSPF (Heating Seasonal Performance Factor) rating measure for a heat pump?",
    options: [
      "The heat pump's cooling efficiency in summer",
      "The noise level of the heat pump compressor",
      "The refrigerant capacity of the system",
      "The heat pump's heating efficiency over an entire heating season",
    ],
    correctAnswer: 3,
    explanation:
      "HSPF（供暖季节性能系数）衡量热泵在整个供暖季节的供暖效率，等于总热量输出（BTU）除以总耗电量（瓦时）。HSPF值越高，热泵供暖越节能。美国当前联邦法规要求新型热泵的最低HSPF2为7.5（采用更新版测试标准），加州西南部地区要求更高。",
    category: "hvac",
  },
  {
    id: 184,
  ...
  },
  {
    id: 200,
    question:
      "What is the primary benefit of an ECM (Electronically Commutated Motor) variable-speed blower in a modern HVAC system?",
    options: [
      "It eliminates the need for air filters",
      "It allows the system to operate without refrigerant",
      "It operates at multiple speeds for better efficiency, quieter operation, and improved humidity control",
      "It replaces the outdoor condenser unit",
    ],
    correctAnswer: 2,
    explanation:
      "ECM变速风机马达可在多种速度下运行，根据供暖或制冷需求精确调节气流。与单速马达相比，ECM马达最多节省60-75%的风机电能，运行更安静；在低速长时间运行时能更有效地去除空气中的湿气，提供更均匀的室内温度分布，是加州Title 24节能要求推荐的技术。",
    category: "hvac",
  },
