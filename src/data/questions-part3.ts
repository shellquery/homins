...
export const questionsPart3: Question[] = [
  ...
  },
  {
    id: 429,
    question:
      "When an older masonry chimney is retrofitted for use with a new gas appliance, what upgrade is typically required?",
    options: [
      "Painting the interior masonry with heat-resistant paint",
      "Installing a properly sized metal liner to handle different flue gas temperatures and condensation",
      "Adding an external chimney cap only",
      "Widening the flue opening by at least 6 inches",
    ],
    correctAnswer: 1,
    explanation:
      "当旧砖石烟囱改用新燃气设备时，通常需要安装尺寸合适的金属衬管。燃气设备产生的烟气温度较低，容易在旧烟囱内壁形成冷凝，导致效率下降和结构损坏。正确尺寸的不锈钢衬管可解决冷凝问题并确保安全排烟。",
    category: "fireplace",
  },
  {
    id: 430,
